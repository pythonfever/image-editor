from tkinter import Frame, Button, LEFT, Toplevel, Label, Scale, Button, HORIZONTAL, RIGHT, Canvas, CENTER, ROUND
...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.negative_button = Button(master=self,width=25, text="Negative")
        self.black_white_button = Button(master=self,width=25, text="Black White")
        self.sepia_button = Button(master=self,width=25, text="Sepia")
        self.emboss_button = Button(master=self,width=25, text="Emboss")
        self.gaussian_blur_button = Button(master=self,width=25, text="Gaussian Blur")
        self.median_blur_button = Button(master=self,width=25, text="Median Blur")
        self.cancel_button = Button(master=self,width=12, text="Cancel")
        self.apply_button = Button(master=self,width=12, text="Apply")
...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.save_as_button = Button(self, text="Save As", width=10)
        self.draw_button = Button(self, text="Draw", width=10)
        self.crop_button = Button(self, text="Crop", width=10)
        self.filter_button = Button(self, text="Filter", width=10)
        self.adjust_button = Button(self, text="Adjust", width=10)
...
class Main(tk.Tk):
    ...
    def __init__(self):
        ...
        self.title("Image Editor By Python Fever")
